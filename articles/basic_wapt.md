...
![image-alternative](/website/article/static/img/wapt-spds-xss-find.webp)

So now let's inject some HTML code, I will try a `<h1>This shouldn't work</h1>`. It now displays this:

![image-alternative](/website/article/static/img/wapt-spds-xss-attempt.webp)
...
![image-alternative](/website/article/static/img/wapt-spds-session.webp)
...
![image-alternative](/website/article/static/img/wapt-viperidae-memory.webp)
...
![image-alternative](/website/article/static/img/wapt-viperidae-memory-after.webp)
...
![image-alternative](/website/article/static/img/wapt-blog-file-test.webp)
...
![image-alternative](/website/article/static/img/wapt-blog-duck.webp)
